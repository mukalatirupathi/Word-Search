...
public class WordSearchConstant {
    ...
    public static final String DATABASE_ERROR_MSG = "Eroor";
    ...
    public static final String INVALID_ARGUMENT_ERROR = "Plz provide first argument as filepath in the double qoutes";
